...
<form method='POST'>
  <div class='row'>
    <div class='col-sm-12' style='height:100px; text-align:center;'><h2><?PHP echo $dX['text_title'];?></h2><p style="margin:25px; padding25px; background-color:lightyellow;"><?PHP echo $dX['text_block'];?></p></div>
  </div>
  <div class='row'>
