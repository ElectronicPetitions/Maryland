...
if (isset($_POST['web_first_name'])){
  ...
  if(isset($_POST['web_last_name']) && isset($_POST['web_midle_name']) && isset($_POST['web_first_name'])){
     setcookie("web_name", $web_first_name.' '.$web_middle_name.' '.$web_last_name); 
  }elseif(isset($_POST['web_last_name']) && isset($_POST['web_first_name'])){
  ...
  $web_street_name='';
  if (isset($_POST['web_street_name'])){
    if ($_POST['web_street_name'] != ''){
     $web_street_name = $_POST['web_street_name'];
     setcookie("web_street_name", $web_street_name);
    }
  }
  $web_zip_code='';
  ...
  $web_city='';
  if (isset($_POST['web_city'])){
    if ($_POST['web_city'] != ''){
     $web_city = $_POST['web_city'];
     setcookie("web_city", $web_city);
    }
  }
  $web_county='';
  if (isset($_POST['web_county'])){
    if ($_POST['web_county'] != ''){
     $web_county = $_POST['web_county'];
     setcookie("web_county", $web_county);
    }
  }
  $contact_phone='';
...
<form method='POST'>
  ...
  <div class='row'>
    <div class='col-sm-3' style='text-align:right;'><h2>Middle Name</h2></div>
    <div class='col-sm-6' style='text-align:left;'><input class="form-control input-lg" name='web_middle_name' required oninvalid="this.setCustomValidity('Please enter only your middle name')" oninput="this.setCustomValidity('')" ></div>
    <div class='col-sm-1' style='text-align:center;'><button type="submit" class="btn btn-success btn-lg btn-block">↴</button></div>
  </div>  
  ...
  <div class='row'>
    <div class='col-sm-3' style='text-align:right;'><h2>Street Name</h2></div>
    <div class='col-sm-6' style='text-align:left;'><input class="form-control input-lg" name='web_street_name' required oninvalid="this.setCustomValidity('Please enter your street name')" oninput="this.setCustomValidity('')"> </div>
    <div class='col-sm-1' style='text-align:center;'><button type="submit" class="btn btn-success btn-lg btn-block">↴</button></div>
  </div>  
  <div class='row'>
     <div class='col-sm-3' style='text-align:right; background-color:lightyellow;'><h3>House: 321 Here St.</h3></div>
     <div class='col-sm-6' style='text-align:left; background-color:lightyellow;'><h3>Use: Here St.</h3></div>
     <div class='col-sm-1' style='text-align:center;'></div>
  </div>
  <div class='row'>
     <div class='col-sm-3' style='text-align:right;'><h2>City</h2></div>
     <div class='col-sm-6' style='text-align:left;'><input class="form-control input-lg" name='web_city' required oninvalid="this.setCustomValidity('Please enter your city name')" oninput="this.setCustomValidity('')"> </div>
     <div class='col-sm-1' style='text-align:center;'><button type="submit" class="btn btn-success btn-lg btn-block">↴</button></div>
  </div>
  <div class='row'>
  ...
  <div class='row'>
     <div class='col-sm-3' style='text-align:right;'><h2>County</h2></div>
     <div class='col-sm-6' style='text-align:left;'><input class="form-control input-lg" name='web_county' required oninvalid="this.setCustomValidity('Please enter your County or Balitmore City')" oninput="this.setCustomValidity('')"> </div>
     <div class='col-sm-1' style='text-align:center;'><button type="submit" class="btn btn-success btn-lg btn-block">↴</button></div>
  </div>
  <div class='row'>
  ...
  <div class='row'>
     <div class='col-sm-10' style='text-align:center;'>* E-Mail is not required, and will only be used with the petitioners to reach you.</div>
  </div>
     <div class='row'>
     <div class='col-sm-10' style='text-align:center;'>** PHONE NUMBER IS REQUIRED BY STATE OF MARYLAND.</div>
  </div>
</form>
