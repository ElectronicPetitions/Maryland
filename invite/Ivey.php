<?PHP 
setcookie("invite", "Ivey", time()+3600, "/"); // we use this later
?>
<!DOCTYPE html>
<html lang="en">  
<head>
...
<?PHP
slack_general($d['tab_name'].' Home Page Loaded ('.$_COOKIE['invite'].')','md-petition');
?>
<div class='row'>
...
<div id="fb-root"></div>
 ...
 <tr>
  <td><div class="fb-share-button" 
     data-href="https://www.md-petition.com/invite/Ivey.php" 
     data-layout="box_count" data-size="large">
   </div></td>
   <td><input type='text' size='50' value='https://www.md-petition.com/invite/Ivey.php' id='Ivey'><button onclick='myFunction("Ivey")'>Copy Link</button></td>
   </tr>
 </table></center>
</div>
</div>
