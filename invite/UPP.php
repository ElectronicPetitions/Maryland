...
setcookie("invite", "UPP", time()+3600, "/"); // we use this later
?>
<!DOCTYPE html>
<html lang="en">  
<head>
...
<script>
  ...
  $q = "select * from petitions where petition_id = '12'";
  $r = $petition->query($q);
  $d = mysqli_fetch_array($r);
  include_once('../slack.php');
  ?>
  <meta property="og:url"           content="https://www.md-petition.com/invite/UPP.php" />
  ...
  <meta property="og:image"         content="https://www.uppmaryland.org/_images/upp-logo-a.jpg" />
...
<?PHP
slack_general('UPP Home Page Loaded ('.$_COOKIE['invite'].')','md-petition');
?>
...
<div id="fb-root"></div>
 ...
 <tr>
  <td><div class="fb-share-button" 
     data-href="https://www.md-petition.com/invite/UPP.php" 
  ...
  data-url="https://www.md-petition.com/invite/UPP.php">
     Tweet</a></td>
   <td><input type='text' size='50' value='http://md-petition.com/invite/UPP.php' id='UPP'><button onclick='myFunction("UPP")'>Copy Link</button></td>
   <td><a href='../printable_qr_code.php?short=<?PHP echo $d['web_short_name'];?>'><img src='https://www.md-petition.com/qrcode.php?s=qrl&d=https://www.md-petition.com/invite/UPP.php'></a></td>
   </tr>
 </table>
</center>
